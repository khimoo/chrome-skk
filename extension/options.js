...
function onload() {
  ...
  var sandS_checkbox = document.getElementById('sandS_checkbox'); // ← 追加
  ...
  chrome.storage.sync.get('options', (data) => {
    ...
    // SandS
    if (data.options && typeof data.options.sandS !== "undefined") {
      sandS_checkbox.checked = data.options.sandS;
    }
  });
  ...
  document.getElementById('reload_button').onclick = function () {
    var options = {
      ...
      sandS: sandS_checkbox.checked // SandS
    };
